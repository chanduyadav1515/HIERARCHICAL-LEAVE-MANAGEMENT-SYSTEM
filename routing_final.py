...
label_F.place(x=20, y=10)
label_dept =Label(main, text="Select Department", font=('Helvetica', 12), fg='blue',bg="white")
label_dept .place(x=20, y=45)
label_Hod =Label(main, text="HEAD OF THE DEPARTMENT", font=('Helvetica ', 12 ,'underline'), fg='maroon', bg="white")
label_Hod.place(x=20, y=185)
label_hod =Label(main, text="Select Department ", font=('Helvetica', 12), fg='blue', bg="white")
label_hod .place(x=20, y=225)
label_Dean =Label(main, text="DEAN", font=('Helvetica ', 12 ,'underline'), fg='maroon', bg="white")
label_Dean.place(x=20, y=275)
label_hod =Label(main, text="Select Department ", font=('Helvetica', 12), fg='blue', bg="white")
label_hod .place(x=20, y=310)
